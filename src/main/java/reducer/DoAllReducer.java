 ...
 * Output: <NullWritable, Text> - Output key-value pair with NULL key and records after processing as the value.
 */
public class DoAllReducer extends Reducer<Text, Text, NullWritable, Text> {
     ...
     *                The output key is NULL, output value is records after processing.
